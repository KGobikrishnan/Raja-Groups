...
// Reusable SVG icon library for the entire Raja Group website
...
const icons = {
  ...
  tool: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M17.64 2.36a2.12 2.12 0 0 1 3 3L14 12l-3-3 6.64-6.64z" />
    </svg>
  ),
  factory: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20V8l5 4V8l5 4V4h10v16H2z" />
      <path d="M7 17h.01" /><path d="M12 17h.01" /><path d="M17 17h.01" />
    </svg>
  ),
  ...
  handshake: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3" />
      <path d="M13 7h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3" />
      <path d="M9 12h6" />
    </svg>
  ),
  seedling: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 8c0-4 4-8 8-8 0 4-4 8-8 8z" />
    </svg>
  ),
  mapPin: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  pickaxe: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14 10l-2 2" /><path d="M4 20l8-8" />
      <path d="M14.5 2.5a4.95 4.95 0 0 1 7 7l-7-7z" />
    </svg>
  ),
  plug: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22v-5" /><path d="M9 8V1" /><path d="M15 8V1" />
